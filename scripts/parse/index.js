...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-07-14.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-07-14.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-07-14_parsed.csv`;

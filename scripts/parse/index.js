...
const DATE = '2021-02-20';
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2021-02-20.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-02-20.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-02-20_parsed.csv`;

...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2021-03-05.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-03-05.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-03-05_parsed.csv`;

...
const DATE = '2021-02-13';
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2021-02-13.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-02-13.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-02-13_parsed.csv`;

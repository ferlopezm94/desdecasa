...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2021-02-24.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-02-24.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-02-24_parsed.csv`;

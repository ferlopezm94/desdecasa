...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-06-29.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-06-29.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-06-29_parsed.csv`;

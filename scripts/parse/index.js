...
const DATE = '2020-09-27';
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-09-27.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-09-27.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-09-27_parsed.csv`;

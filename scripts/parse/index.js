...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-06-19.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-06-19.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-06-19_parsed.csv`;

...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2021-01-13.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-01-13.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-01-13_parsed.csv`;

...
const DATE = '2021-03-11';
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2021-03-11.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-03-11.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-03-11_parsed.csv`;

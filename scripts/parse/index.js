...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-05-26.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-05-26.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-05-26_parsed.csv`;

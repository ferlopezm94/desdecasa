...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-05-31.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-05-31.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-05-31_parsed.csv`;

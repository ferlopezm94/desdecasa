...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-10-21.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-10-21.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-10-21_parsed.csv`;

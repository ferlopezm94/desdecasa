...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-10-30.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-10-30.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-10-30_parsed.csv`;

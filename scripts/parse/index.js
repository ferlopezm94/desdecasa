...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2021-01-08.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-01-08.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-01-08_parsed.csv`;

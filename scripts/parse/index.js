...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-08-01.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-08-01.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-08-01_parsed.csv`;

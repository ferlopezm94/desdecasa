...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2021-03-06.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-03-06.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-03-06_parsed.csv`;

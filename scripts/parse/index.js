...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-08-10.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-08-10.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-08-10_parsed.csv`;

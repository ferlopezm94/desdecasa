...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-09-08.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-09-08.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-09-08_parsed.csv`;

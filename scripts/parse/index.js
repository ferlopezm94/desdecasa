...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-11-12.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-11-12.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-11-12_parsed.csv`;

...
const DATE = '2020-08-31';
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-08-31.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-08-31.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-08-31_parsed.csv`;

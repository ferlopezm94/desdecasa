...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-07-09.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-07-09.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-07-09_parsed.csv`;

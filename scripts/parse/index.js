...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-06-05.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-06-05.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-06-05_parsed.csv`;

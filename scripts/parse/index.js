...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-10-22.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-10-22.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-10-22_parsed.csv`;

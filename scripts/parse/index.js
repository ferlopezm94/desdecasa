...
const DATE = '2020-09-29';
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-09-29.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-09-29.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-09-29_parsed.csv`;

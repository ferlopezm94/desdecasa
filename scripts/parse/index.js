...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2021-01-11.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-01-11.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-01-11_parsed.csv`;

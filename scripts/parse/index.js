...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-11-11.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-11-11.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-11-11_parsed.csv`;

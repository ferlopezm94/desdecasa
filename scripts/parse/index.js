...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-07-01.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-07-01.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-07-01_parsed.csv`;

...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2021-03-10.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-03-10.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-03-10_parsed.csv`;

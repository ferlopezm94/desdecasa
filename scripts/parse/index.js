...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-11-20.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-11-20.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-11-20_parsed.csv`;

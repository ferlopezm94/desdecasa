...
const DATE = '2020-12-17';
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-12-17.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-12-17.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-12-17_parsed.csv`;

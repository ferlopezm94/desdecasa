...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-10-23.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-10-23.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-10-23_parsed.csv`;

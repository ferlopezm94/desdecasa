...
const DATE = '2020-09-11';
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-09-11.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-09-11.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-09-11_parsed.csv`;

...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2021-02-03.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-02-03.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-02-03_parsed.csv`;

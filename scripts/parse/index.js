...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2021-01-23.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-01-23.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-01-23_parsed.csv`;

...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-06-04.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-06-04.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-06-04_parsed.csv`;

...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-08-29.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-08-29.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-08-29_parsed.csv`;

...
const DATE = '2020-11-18';
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-11-18.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-11-18.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-11-18_parsed.csv`;

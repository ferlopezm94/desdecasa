...
const DATE = '2020-08-14';
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-08-14.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-08-14.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-08-14_parsed.csv`;

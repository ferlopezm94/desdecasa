...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2021-02-19.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-02-19.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-02-19_parsed.csv`;

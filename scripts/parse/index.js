...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2021-03-14.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-03-14.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-03-14_parsed.csv`;

...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-09-05.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-09-05.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-09-05_parsed.csv`;

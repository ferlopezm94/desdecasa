...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2021-01-02.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-01-02.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-01-02_parsed.csv`;

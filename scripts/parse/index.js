...
const DATE = '2020-09-07';
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-09-07.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-09-07.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-09-07_parsed.csv`;

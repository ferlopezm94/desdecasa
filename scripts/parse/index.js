...
const DATE = '2021-02-12';
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2021-02-12.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-02-12.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-02-12_parsed.csv`;

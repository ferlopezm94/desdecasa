...
const DATE = '2021-01-24';
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2021-01-24.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-01-24.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2021-01-24_parsed.csv`;

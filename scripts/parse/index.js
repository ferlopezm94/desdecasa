...
const OUTPUT_ZIP = `${__dirname}/../../src/data/raw/2020-06-09.zip`;
const INPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-06-09.csv`;
const OUTPUT_FILE_NAME = `${__dirname}/../../src/data/raw/2020-06-09_parsed.csv`;
